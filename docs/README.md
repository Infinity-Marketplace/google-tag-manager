...
> ⚠️ The HTML blacklist is the VTEX Google Tag Manager app's default. If you want to disable this restriction, go to `https://{accountName}.myvtex.com/admin/apps/infinityro.google-tag-manager@0.x/setup` and check the toggle below.
